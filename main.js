            ...
            <div class="top_nav">
                ...
                <span onclick="close_menu()" class="close_menu"><i class="fa-regular fa-circle-xmark"></i></span>
                    <ul>
                        ...
                        <li class="dropdown">
                          <a class="drop_menu" href="#" onclick="dropDown()">جميع الدورات <i class="fa-solid fa-angle-down"></i></a>
                        ...
                        <li class="dropdown">
                          <a class="drop_menu" href="#" onclick="dropDown()">دورات تعليمية <i class="fa-solid fa-angle-down"></i></a>
                          <ul class="dropdown-content">
                                <li><a href="pivot table.html">pivot table</a></li>
                                <li><a href="دوال الاكسيل.html">دوال الاكسيل</a></li>
                                <li><a href="power point.html">power point</a></li>
                                <li><a href="17 اختصار.html">اهم 17 اختصار</a></li>
                                <li><a href="word-2.html">Word</a></li>
                          </ul>
                        </li>
                        <li><a href="#foo_main">Contact Us</a></li>
...
foo_main.innerHTML = `
 ...
 <div class="container">
            ...
            <div class="end">
                <div class="web_dev">
                        <p>الموقع مصمم من قبل "عبدالرحمن خالد" للتواصل لتصميم المواقع</p>
                        <h3>Mobile: <a href="tel:+201147010062">01147010062</a></h3>
                        <h3>Email: <a href="mailto:abdelrahman.khaled2010@outlook.com">abdelrahman.khaled2010@outlook.com</a></h3>
                    </div>
            </div>
